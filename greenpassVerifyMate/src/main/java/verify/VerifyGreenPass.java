...
public class VerifyGreenPass {
    ...
    public VerifyGreenPass() {
    }

    public static String[] verifyGreenPass(String path) throws Exception {
        String strName;
        String strSurname;
        String strDate;
        String strNDosi;
        ...
        strNDosi=support.substring(0,support.indexOf(","));
        ret[3]=strNDosi;
    ...
    private static void fetchCertificate(String resumeToken, List<String> possibleKids) throws CertificateException, IOException, InterruptedException {
